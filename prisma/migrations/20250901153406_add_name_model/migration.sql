/*
  ...
  - Added the required column `nameId` to the `recordings` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_recordings" ("createdAt", "duration", "fileHash", "filename", "filesize", "id", "isCorrupted", "lastQualityCheck", "method", "mimetype", "nameListId", "originalFilename", "status", "updatedAt", "userId") SELECT "createdAt", "duration", "fileHash", "filename", "filesize", "id", "isCorrupted", "lastQualityCheck", "method", "mimetype", "nameListId", "originalFilename", "status", "updatedAt", "userId" FROM "recordings";
...
-- CreateIndex
CREATE UNIQUE INDEX "names_importOrder_key" ON "names"("importOrder");

-- CreateIndex
CREATE INDEX "names_importOrder_idx" ON "names"("importOrder");
